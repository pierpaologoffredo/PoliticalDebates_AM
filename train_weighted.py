...
from utils.models import BertForSequenceTagging, BertForSequenceClassificationWeighted, RobertaForSequenceClassificationWeighted
from utils.metrics import compute_metrics
from utils.tokenizer import ExtendedBertTokenizer, ExtendedRobertaTokenizer
...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        features = processor.convert_examples_to_features(examples, max_seq_length=args.max_seq_length, tokenizer=tokenizer, logger=logger, forSequenceTagging=forSequenceTagging, min_seq_length=5, sep_token_extra=extra_sep)
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="The data_relclass directory where the model predictions and checkpoints will be written.",
    )
    ...
    parser.add_argument(
        "--overwrite_output_dir", action="store_true", help="Overwrite the content of the data_relclass directory",
    )
    parser.add_argument(
